...
const WEEKS: WeekSeed[] = [
  ...
  },
  {
    ...
    days: [
      ...
      { shape: 'crown', cx: 1025, cy: 353, size: 25, angle: -104, fill: '#abbdd5', opacity: 0.348, blend: 'screen', blur: 0.5, ratio: 1.74, scan: 0.466, dim: 0.56 },
      { shape: 'spade', cx: 305, cy: 833, size: 22, angle: 148, fill: '#32434e', opacity: 0.418, blend: 'multiply', blur: 0.5, ratio: 2.58, scan: 0.433, dim: 0.48 },
    ],
  },
  {
    image: 'boating',
  ...
  },
  {
    ...
    clutter: 0.685,
    days: [
      { shape: 'blossom', cx: 1097, cy: 1577, size: 29, angle: -132, fill: '#17241e', opacity: 1, blend: 'screen', blur: 0.5, ratio: 2.36, scan: 0.572, dim: 0.787 },
      { shape: 'cross', cx: 569, cy: 161, size: 27, angle: 155, fill: '#3f421d', opacity: 0.252, blend: 'multiply', blur: 0.5, ratio: 1.82, scan: 0.502, dim: 0.448 },
      { shape: 'star', cx: 2273, cy: 1025, size: 25, angle: -38, fill: '#a4a7c5', opacity: 0.366, blend: 'screen', blur: 0.5, ratio: 3.06, scan: 0.501, dim: 0.675 },
      { shape: 'crescent', cx: 1745, cy: 1577, size: 23, angle: -46, fill: '#98bdaa', opacity: 0.311, blend: 'screen', blur: 0.5, ratio: 2.43, scan: 0.482, dim: 0.75 },
      { shape: 'heart', cx: 449, cy: 1457, size: 20, angle: 70, fill: '#c9abaf', opacity: 0.213, blend: 'screen', blur: 0.5, ratio: 1.53, scan: 0.446, dim: 0.623 },
      { shape: 'anchor', cx: 1745, cy: 257, size: 18, angle: -104, fill: '#a0c2b1', opacity: 0.465, blend: 'screen', blur: 0.5, ratio: 2.41, scan: 0.436, dim: 0.663 },
      { shape: 'fish', cx: 1505, cy: 1073, size: 16, angle: 148, fill: '#a6b1c6', opacity: 0.422, blend: 'screen', blur: 0.5, ratio: 2.64, scan: 0.411, dim: 0.625 },
    ],
  },
  {
    image: 'hunters',
    ...
    days: [
      ...
      { shape: 'snowflake', cx: 1745, cy: 209, size: 27, angle: 85, fill: '#b2c9ab', opacity: 0.096, blend: 'screen', blur: 0.5, ratio: 1.41, scan: 0.494, dim: 0.573 },
      ...
      { shape: 'bolt', cx: 1601, cy: 617, size: 23, angle: -134, fill: '#585338', opacity: 0.437, blend: 'multiply', blur: 0.5, ratio: 2.16, scan: 0.412, dim: 0.366 },
      { shape: 'arrow', cx: 2057, cy: 1577, size: 20, angle: -70, fill: '#a5b388', opacity: 0.401, blend: 'screen', blur: 0.5, ratio: 2.05, scan: 0.43, dim: 0.685 },
      { shape: 'droplet', cx: 641, cy: 593, size: 18, angle: 104, fill: '#bcb697', opacity: 0.398, blend: 'screen', blur: 0.5, ratio: 1.86, scan: 0.416, dim: 0.751 },
      { shape: 'leaf', cx: 1601, cy: 1241, size: 16, angle: -148, fill: '#b8c9ab', opacity: 0.543, blend: 'screen', blur: 0.5, ratio: 2.46, scan: 0.372, dim: 0.515 },
    ],
  },
  {
    image: 'issus',
  ...
  },
  {
    ...
    clutter: 0.656,
    days: [
      { shape: 'clover', cx: 1793, cy: 1217, size: 29, angle: -168, fill: '#351919', opacity: 1, blend: 'screen', blur: 0.5, ratio: 2.98, scan: 0.556, dim: 0.871 },
      { shape: 'triangle', cx: 2441, cy: 1745, size: 27, angle: -25, fill: '#b78f8f', opacity: 0.28, blend: 'screen', blur: 0.5, ratio: 4.17, scan: 0.524, dim: 0.836 },
      { shape: 'blossom', cx: 641, cy: 1793, size: 25, angle: -38, fill: '#cc6982', opacity: 0.273, blend: 'screen', blur: 0.5, ratio: 2.56, scan: 0.499, dim: 0.869 },
      { shape: 'heart', cx: 233, cy: 761, size: 23, angle: -46, fill: '#cb8c70', opacity: 0.148, blend: 'screen', blur: 0.5, ratio: 1.67, scan: 0.478, dim: 0.895 },
      { shape: 'anchor', cx: 2201, cy: 689, size: 20, angle: 70, fill: '#c9bcaa', opacity: 0.414, blend: 'screen', blur: 0.5, ratio: 2.48, scan: 0.421, dim: 0.6 },
      { shape: 'fish', cx: 1049, cy: 689, size: 18, angle: -104, fill: '#cd8283', opacity: 0.582, blend: 'screen', blur: 0.5, ratio: 3.03, scan: 0.421, dim: 0.804 },
      { shape: 'arrow', cx: 2321, cy: 1241, size: 16, angle: 148, fill: '#b8818a', opacity: 0.629, blend: 'screen', blur: 0.5, ratio: 2.7, scan: 0.403, dim: 0.806 },
    ],
  },
  {
    image: 'venice',
