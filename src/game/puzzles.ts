...
const WEEKS: WeekSeed[] = [
  ...
  },
  {
    ...
    days: [
      ...
      { shape: 'crescent', cx: 1025, cy: 353, size: 25, angle: -104, fill: '#abbdd5', opacity: 0.344, blend: 'screen', blur: 0.5, ratio: 1.62, scan: 0.365 },
  ...
  },
  {
    ...
    days: [
      ...
      { shape: 'bolt', cx: 1913, cy: 473, size: 20, angle: 110, fill: '#c0a99c', opacity: 0.48, blend: 'screen', blur: 0.5, ratio: 2.42, scan: 0.376 },
      { shape: 'fish', cx: 2177, cy: 137, size: 18, angle: 104, fill: '#90bcaf', opacity: 0.213, blend: 'screen', blur: 0.5, ratio: 1.59, scan: 0.353 },
      { shape: 'anchor', cx: 1505, cy: 1145, size: 16, angle: -148, fill: '#be99a7', opacity: 0.429, blend: 'screen', blur: 0.5, ratio: 1.16, scan: 0.339 },
    ],
  },
  {
    image: 'jatte',
    ...
    days: [
      ...
      { shape: 'crescent', cx: 1841, cy: 449, size: 16, angle: 148, fill: '#494c30', opacity: 0.293, blend: 'multiply', blur: 0.5, ratio: 1.56, scan: 0.342 },
    ],
  },
  {
    image: 'hunters',
    ...
    days: [
      ...
      { shape: 'crescent', cx: 1457, cy: 1649, size: 23, angle: 46, fill: '#69562d', opacity: 0.728, blend: 'multiply', blur: 0.5, ratio: 3.66, scan: 0.402 },
  ...
  },
  {
    ...
    days: [
      ...
      { shape: 'crescent', cx: 2441, cy: 1841, size: 28, angle: -70, fill: '#2b7d79', opacity: 0.511, blend: 'multiply', blur: 0.5, ratio: 4.97, scan: 0.367 },
  ...
  },
  {
    ...
    days: [
      ...
      { shape: 'crescent', cx: 1601, cy: 569, size: 25, angle: 104, fill: '#5f9e39', opacity: 0.257, blend: 'multiply', blur: 0.5, ratio: 1.52, scan: 0.367 },
