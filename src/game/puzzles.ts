...
const WEEKS: WeekSeed[] = [
  ...
  },
  {
    ...
    clutter: 0.685,
    days: [
      { shape: 'key', cx: 1097, cy: 1577, size: 29, angle: 12, fill: '#2b4338', opacity: 1, blend: 'screen', blur: 0.5, ratio: 3.71, scan: 0.569, dim: 0.787 },
      { shape: 'bolt', cx: 569, cy: 161, size: 27, angle: 155, fill: '#3f421d', opacity: 0.468, blend: 'multiply', blur: 0.5, ratio: 3.32, scan: 0.502, dim: 0.448, cover: 0.5, base: '#8c9440' },
      { shape: 'anchor', cx: 2273, cy: 1025, size: 25, angle: 34, fill: '#a4a7c5', opacity: 0.457, blend: 'screen', blur: 0.5, ratio: 3.94, scan: 0.506, dim: 0.675, cover: 0.5, base: '#4a4d69' },
      { shape: 'bell', cx: 1745, cy: 1577, size: 23, angle: -46, fill: '#98bdaa', opacity: 0.23, blend: 'screen', blur: 0.5, ratio: 1.84, scan: 0.489, dim: 0.75, cover: 0.5, base: '#3a4e43' },
      { shape: 'crescent', cx: 449, cy: 1457, size: 20, angle: 70, fill: '#c9abaf', opacity: 0.311, blend: 'screen', blur: 0.5, ratio: 2.03, scan: 0.44, dim: 0.623, cover: 0.5, base: '#795358' },
      { shape: 'crown', cx: 1745, cy: 257, size: 18, angle: -104, fill: '#a0c2b1', opacity: 0.394, blend: 'screen', blur: 0.5, ratio: 2.13, scan: 0.429, dim: 0.663, cover: 0.5, base: '#455f51' },
      { shape: 'house', cx: 1505, cy: 1073, size: 16, angle: 148, fill: '#a6b1c6', opacity: 0.28, blend: 'screen', blur: 0.5, ratio: 1.86, scan: 0.408, dim: 0.625, cover: 0.5, base: '#4e586a' },
    ],
  },
  {
    image: 'hunters',
    ...
    clutter: 0.657,
    days: [
      { shape: 'blossom', cx: 2201, cy: 185, size: 29, angle: -156, fill: '#141810', opacity: 1, blend: 'screen', blur: 0.5, ratio: 2.45, scan: 0.527, dim: 0.603 },
      { shape: 'butterfly', cx: 1745, cy: 209, size: 27, angle: 25, fill: '#b2c9ab', opacity: 0.096, blend: 'screen', blur: 0.5, ratio: 1.46, scan: 0.486, dim: 0.573, cover: 0.5, base: '#60735a' },
      { shape: 'clover', cx: 1457, cy: 1649, size: 25, angle: 146, fill: '#846b39', opacity: 0.982, blend: 'multiply', blur: 0.5, ratio: 4.56, scan: 0.425, dim: 0.213, cover: 0.5, base: '#e4d8bf' },
      { shape: 'sailboat', cx: 1601, cy: 617, size: 23, angle: 46, fill: '#585338', opacity: 0.284, blend: 'multiply', blur: 0.5, ratio: 1.6, scan: 0.41, dim: 0.366, cover: 0.5, base: '#b0ab91' },
      { shape: 'apple', cx: 2057, cy: 1577, size: 20, angle: -70, fill: '#a5b388', opacity: 0.319, blend: 'screen', blur: 0.5, ratio: 1.88, scan: 0.427, dim: 0.685, cover: 0.5, base: '#272b21' },
      { shape: 'puzzle', cx: 641, cy: 593, size: 18, angle: 104, fill: '#bcb697', opacity: 0.441, blend: 'screen', blur: 0.5, ratio: 1.97, scan: 0.417, dim: 0.751, cover: 0.5, base: '#4c4935' },
  ...
  },
  {
    ...
    days: [
      ...
      { shape: 'heart', cx: 449, cy: 1865, size: 37, angle: -25, fill: '#b39d88', opacity: 0.116, blend: 'screen', blur: 0.5, ratio: 1.65, scan: 0.431, dim: 0.888, cover: 0.5, base: '#2d2620' },
      { shape: 'tree', cx: 1073, cy: 1073, size: 34, angle: 34, fill: '#b4c9cf', opacity: 0.201, blend: 'screen', blur: 0.5, ratio: 1.78, scan: 0.353, dim: 0.525, cover: 0.5, base: '#6a7d83' },
      { shape: 'diamond', cx: 2393, cy: 3065, size: 31, angle: 134, fill: '#cb9871', opacity: 0.198, blend: 'screen', blur: 0.5, ratio: 2.07, scan: 0.364, dim: 0.868, cover: 0.5, base: '#392515' },
      { shape: 'bone', cx: 281, cy: 3137, size: 28, angle: -110, fill: '#c7826c', opacity: 0.205, blend: 'screen', blur: 0.5, ratio: 1.79, scan: 0.341, dim: 0.866, cover: 0.5, base: '#2a1710' },
      { shape: 'droplet', cx: 2201, cy: 1577, size: 25, angle: -104, fill: '#a1b9c3', opacity: 0.28, blend: 'screen', blur: 0.5, ratio: 1.07, scan: 0.301, dim: 0.658, cover: 0.5, base: '#46595f' },
      { shape: 'umbrella', cx: 905, cy: 233, size: 22, angle: 148, fill: '#c88693', opacity: 0.401, blend: 'screen', blur: 0.5, ratio: 2.52, scan: 0.298, dim: 0.777, cover: 0.5, base: '#52252e' },
    ],
  },
  {
    image: 'babel',
    ...
    clutter: 0.631,
    days: [
      { shape: 'sun', cx: 2105, cy: 1553, size: 40, angle: -12, fill: '#3e321b', opacity: 1, blend: 'screen', blur: 0.5, ratio: 2.67, scan: 0.528, dim: 0.763 },
      { shape: 'cloud', cx: 2393, cy: 593, size: 37, angle: 25, fill: '#284641', opacity: 0.336, blend: 'multiply', blur: 0.5, ratio: 1.33, scan: 0.463, dim: 0.46, cover: 0.5, base: '#5a9c91' },
      { shape: 'cross', cx: 1913, cy: 641, size: 34, angle: -34, fill: '#aac9ab', opacity: 0.528, blend: 'screen', blur: 0.5, ratio: 2.3, scan: 0.452, dim: 0.632, cover: 0.5, base: '#587258' },
      { shape: 'triangle', cx: 425, cy: 569, size: 31, angle: 166, fill: '#517e68', opacity: 0.17, blend: 'multiply', blur: 0.5, ratio: 1.66, scan: 0.362, dim: 0.108, cover: 0.5, base: '#e2ebe6' },
      { shape: 'key', cx: 1169, cy: 185, size: 28, angle: -70, fill: '#4b7576', opacity: 0.426, blend: 'multiply', blur: 0.5, ratio: 1.93, scan: 0.353, dim: 0.189, cover: 0.5, base: '#cfdedf' },
      { shape: 'puzzle', cx: 2369, cy: 1193, size: 25, angle: 104, fill: '#406c5f', opacity: 0.336, blend: 'multiply', blur: 0.5, ratio: 1.85, scan: 0.335, dim: 0.197, cover: 0.5, base: '#afd0c6' },
      { shape: 'house', cx: 1505, cy: 929, size: 22, angle: -148, fill: '#cfc7b1', opacity: 0.336, blend: 'screen', blur: 0.5, ratio: 1.44, scan: 0.349, dim: 0.473, cover: 0.5, base: '#8f8057' },
    ],
  },
  {
    image: 'deheem',
    ...
    clutter: 0.656,
    days: [
      { shape: 'butterfly', cx: 1793, cy: 1217, size: 29, angle: 12, fill: '#2c1615', opacity: 1, blend: 'screen', blur: 0.5, ratio: 2.59, scan: 0.569, dim: 0.871 },
      { shape: 'cross', cx: 2441, cy: 1745, size: 27, angle: 155, fill: '#b78f8f', opacity: 0.319, blend: 'screen', blur: 0.5, ratio: 4.82, scan: 0.52, dim: 0.836, cover: 0.5, base: '#3e2828' },
      { shape: 'crescent', cx: 641, cy: 1793, size: 25, angle: 34, fill: '#cc6982', opacity: 0.465, blend: 'screen', blur: 0.5, ratio: 4.01, scan: 0.499, dim: 0.869, cover: 0.5, base: '#2e1018' },
      { shape: 'note', cx: 233, cy: 761, size: 23, angle: -46, fill: '#cb8c70', opacity: 0.187, blend: 'screen', blur: 0.5, ratio: 1.94, scan: 0.476, dim: 0.895, cover: 0.5, base: '#381f14' },
      { shape: 'bolt', cx: 2201, cy: 689, size: 20, angle: -110, fill: '#c9bcaa', opacity: 0.497, blend: 'screen', blur: 0.5, ratio: 3.15, scan: 0.421, dim: 0.6, cover: 0.5, base: '#756753' },
      { shape: 'arrow', cx: 1049, cy: 689, size: 18, angle: -104, fill: '#cd8283', opacity: 0.472, blend: 'screen', blur: 0.5, ratio: 2.25, scan: 0.422, dim: 0.804, cover: 0.5, base: '#582324' },
      { shape: 'leaf', cx: 2321, cy: 1241, size: 16, angle: 148, fill: '#b8818a', opacity: 0.485, blend: 'screen', blur: 0.5, ratio: 2.19, scan: 0.405, dim: 0.806, cover: 0.5, base: '#2f1b1e' },
    ],
  },
  {
    image: 'venice',
    ...
    clutter: 0.538,
    days: [
      { shape: 'umbrella', cx: 2249, cy: 449, size: 40, angle: -12, fill: '#ced7e0', opacity: 1, blend: 'multiply', blur: 0.5, ratio: 2.82, scan: 0.422, dim: 0.429 },
      { shape: 'clover', cx: 1865, cy: 689, size: 37, angle: -155, fill: '#4d7862', opacity: 0.151, blend: 'multiply', blur: 0.5, ratio: 2.25, scan: 0.349, dim: 0.129, cover: 0.5, base: '#d3e2da' },
      { shape: 'fish', cx: 977, cy: 1025, size: 34, angle: -34, fill: '#bba695', opacity: 0.366, blend: 'screen', blur: 0.5, ratio: 1.79, scan: 0.382, dim: 0.723, cover: 0.5, base: '#4a3d32' },
      { shape: 'sailboat', cx: 1961, cy: 1601, size: 31, angle: 46, fill: '#bed1b7', opacity: 0.198, blend: 'screen', blur: 0.5, ratio: 1.89, scan: 0.324, dim: 0.496, cover: 0.5, base: '#788773' },
      { shape: 'tree', cx: 1337, cy: 1313, size: 28, angle: -70, fill: '#c5caad', opacity: 0.276, blend: 'screen', blur: 0.5, ratio: 1.57, scan: 0.307, dim: 0.528, cover: 0.5, base: '#757a58' },
      { shape: 'apple', cx: 185, cy: 1049, size: 25, angle: 104, fill: '#b49e89', opacity: 0.131, blend: 'screen', blur: 0.5, ratio: 1.1, scan: 0.316, dim: 0.753, cover: 0.5, base: '#2f2822' },
      { shape: 'droplet', cx: 2273, cy: 881, size: 22, angle: -148, fill: '#c2baa0', opacity: 0.273, blend: 'screen', blur: 0.5, ratio: 1.36, scan: 0.303, dim: 0.609, cover: 0.5, base: '#635b40' },
    ],
  },
];
