...
const WEEKS: WeekSeed[] = [
  ...
  },
  {
    ...
    days: [
      ...
      { shape: 'triangle', cx: 2345, cy: 497, size: 37, angle: -25, fill: '#4e471a', opacity: 0.245, blend: 'multiply', blur: 0.5, ratio: 1.24, scan: 0.456, dim: 0.329 },
      { shape: 'blossom', cx: 929, cy: 1049, size: 34, angle: -38, fill: '#505737', opacity: 0.222, blend: 'multiply', blur: 0.5, ratio: 1.48, scan: 0.433, dim: 0.334 },
      { shape: 'leaf', cx: 2273, cy: 977, size: 31, angle: -46, fill: '#385657', opacity: 0.288, blend: 'multiply', blur: 0.5, ratio: 1.79, scan: 0.396, dim: 0.348 },
      { shape: 'house', cx: 353, cy: 305, size: 28, angle: 70, fill: '#94a0d6', opacity: 0.179, blend: 'screen', blur: 0.5, ratio: 1.4, scan: 0.386, dim: 0.705 },
      { shape: 'crown', cx: 1025, cy: 353, size: 25, angle: -104, fill: '#abbdd5', opacity: 0.269, blend: 'screen', blur: 0.5, ratio: 1.34, scan: 0.361, dim: 0.56 },
      { shape: 'spade', cx: 305, cy: 833, size: 22, angle: 148, fill: '#32434e', opacity: 0.332, blend: 'multiply', blur: 0.5, ratio: 2.05, scan: 0.343, dim: 0.48 },
    ],
  },
  {
    image: 'boating',
    ...
    clutter: 0.544,
    days: [
      { shape: 'triangle', cx: 1217, cy: 1745, size: 29, angle: -132, fill: '#b9926f', opacity: 1, blend: 'multiply', blur: 0.5, ratio: 4.99, scan: 0.481, dim: 0.117 },
      { shape: 'blossom', cx: 185, cy: 1697, size: 27, angle: 97, fill: '#85a4bf', opacity: 0.174, blend: 'screen', blur: 0.5, ratio: 3.47, scan: 0.454, dim: 0.806 },
      { shape: 'cross', cx: 2177, cy: 137, size: 25, angle: -34, fill: '#90bcaf', opacity: 0.245, blend: 'screen', blur: 0.5, ratio: 3.06, scan: 0.425, dim: 0.755 },
      { shape: 'tree', cx: 2249, cy: 1289, size: 23, angle: 46, fill: '#5f3d5a', opacity: 0.252, blend: 'multiply', blur: 0.5, ratio: 3.07, scan: 0.398, dim: 0.344 },
      { shape: 'note', cx: 1913, cy: 473, size: 20, angle: -70, fill: '#c0a89d', opacity: 0.276, blend: 'screen', blur: 0.5, ratio: 2.58, scan: 0.38, dim: 0.727 },
      { shape: 'key', cx: 1961, cy: 1601, size: 18, angle: 104, fill: '#6f3d32', opacity: 0.457, blend: 'multiply', blur: 0.5, ratio: 2.59, scan: 0.361, dim: 0.372 },
      { shape: 'crescent', cx: 329, cy: 593, size: 16, angle: -148, fill: '#66414b', opacity: 0.348, blend: 'multiply', blur: 0.5, ratio: 3.3, scan: 0.347, dim: 0.331 },
    ],
  },
  {
    image: 'jatte',
    ...
    clutter: 0.685,
    days: [
      { shape: 'blossom', cx: 1097, cy: 1577, size: 29, angle: -132, fill: '#14201a', opacity: 1, blend: 'screen', blur: 0.5, ratio: 2.09, scan: 0.499, dim: 0.787 },
      { shape: 'cross', cx: 569, cy: 161, size: 27, angle: 155, fill: '#3f421d', opacity: 0.23, blend: 'multiply', blur: 0.5, ratio: 1.68, scan: 0.461, dim: 0.448 },
      { shape: 'star', cx: 2273, cy: 1025, size: 25, angle: -38, fill: '#a4a7c5', opacity: 0.311, blend: 'screen', blur: 0.5, ratio: 2.61, scan: 0.429, dim: 0.675 },
      { shape: 'crescent', cx: 1745, cy: 1577, size: 23, angle: -46, fill: '#98bdaa', opacity: 0.252, blend: 'screen', blur: 0.5, ratio: 1.94, scan: 0.4, dim: 0.75 },
      { shape: 'heart', cx: 449, cy: 1457, size: 20, angle: 70, fill: '#c9abaf', opacity: 0.179, blend: 'screen', blur: 0.5, ratio: 1.31, scan: 0.382, dim: 0.623 },
      { shape: 'anchor', cx: 1745, cy: 257, size: 18, angle: -104, fill: '#a0c2b1', opacity: 0.387, blend: 'screen', blur: 0.5, ratio: 1.98, scan: 0.361, dim: 0.663 },
      { shape: 'fish', cx: 1505, cy: 1073, size: 16, angle: 148, fill: '#a6b1c6', opacity: 0.362, blend: 'screen', blur: 0.5, ratio: 2.25, scan: 0.339, dim: 0.625 },
    ],
  },
  {
    image: 'hunters',
    ...
    clutter: 0.657,
    days: [
      { shape: 'cross', cx: 2201, cy: 185, size: 29, angle: -12, fill: '#141910', opacity: 1, blend: 'screen', blur: 0.5, ratio: 2.33, scan: 0.49, dim: 0.603 },
      { shape: 'snowflake', cx: 1745, cy: 209, size: 27, angle: 85, fill: '#b2c9ab', opacity: 0.088, blend: 'screen', blur: 0.5, ratio: 1.26, scan: 0.457, dim: 0.573 },
      { shape: 'star', cx: 1457, cy: 1649, size: 25, angle: -106, fill: '#846b39', opacity: 0.778, blend: 'multiply', blur: 0.5, ratio: 3.44, scan: 0.425, dim: 0.213 },
      { shape: 'bolt', cx: 1601, cy: 617, size: 23, angle: -134, fill: '#585338', opacity: 0.426, blend: 'multiply', blur: 0.5, ratio: 2.12, scan: 0.405, dim: 0.366 },
      { shape: 'arrow', cx: 2057, cy: 1577, size: 20, angle: -70, fill: '#a5b388', opacity: 0.354, blend: 'screen', blur: 0.5, ratio: 1.8, scan: 0.378, dim: 0.685 },
      { shape: 'droplet', cx: 641, cy: 593, size: 18, angle: 104, fill: '#bcb697', opacity: 0.344, blend: 'screen', blur: 0.5, ratio: 1.63, scan: 0.361, dim: 0.751 },
      { shape: 'leaf', cx: 1601, cy: 1241, size: 16, angle: -148, fill: '#b8c9ab', opacity: 0.5, blend: 'screen', blur: 0.5, ratio: 2.27, scan: 0.347, dim: 0.515 },
    ],
  },
  {
    image: 'issus',
    ...
    clutter: 0.535,
    days: [
      { shape: 'snowflake', cx: 209, cy: 1481, size: 40, angle: -168, fill: '#181f26', opacity: 1, blend: 'screen', blur: 0.5, ratio: 2.29, scan: 0.495, dim: 0.82 },
      { shape: 'star', cx: 449, cy: 1865, size: 37, angle: 47, fill: '#b39d88', opacity: 0.201, blend: 'screen', blur: 0.5, ratio: 3.08, scan: 0.456, dim: 0.888 },
      { shape: 'clover', cx: 1073, cy: 1073, size: 34, angle: -146, fill: '#b4c9cf', opacity: 0.269, blend: 'screen', blur: 0.5, ratio: 2.6, scan: 0.439, dim: 0.525 },
      { shape: 'house', cx: 2393, cy: 3065, size: 31, angle: -46, fill: '#cb9871', opacity: 0.174, blend: 'screen', blur: 0.5, ratio: 1.94, scan: 0.401, dim: 0.868 },
      { shape: 'crown', cx: 281, cy: 3137, size: 28, angle: 70, fill: '#c7826c', opacity: 0.191, blend: 'screen', blur: 0.5, ratio: 1.78, scan: 0.39, dim: 0.866 },
      { shape: 'spade', cx: 2201, cy: 1577, size: 25, angle: -104, fill: '#a1b9c3', opacity: 0.362, blend: 'screen', blur: 0.5, ratio: 1.37, scan: 0.358, dim: 0.658 },
      { shape: 'tree', cx: 905, cy: 233, size: 22, angle: 148, fill: '#c88693', opacity: 0.579, blend: 'screen', blur: 0.5, ratio: 3.88, scan: 0.341, dim: 0.777 },
    ],
  },
  {
    image: 'babel',
    ...
    clutter: 0.631,
    days: [
      { shape: 'star', cx: 2105, cy: 1553, size: 40, angle: -156, fill: '#2d2414', opacity: 1, blend: 'screen', blur: 0.5, ratio: 2.09, scan: 0.492, dim: 0.763 },
      { shape: 'clover', cx: 2393, cy: 593, size: 37, angle: 25, fill: '#284641', opacity: 0.45, blend: 'multiply', blur: 0.5, ratio: 1.65, scan: 0.46, dim: 0.46 },
      { shape: 'triangle', cx: 1913, cy: 641, size: 34, angle: 86, fill: '#aac9ab', opacity: 0.524, blend: 'screen', blur: 0.5, ratio: 2.21, scan: 0.431, dim: 0.632 },
      { shape: 'note', cx: 425, cy: 569, size: 31, angle: 46, fill: '#517e68', opacity: 0.245, blend: 'multiply', blur: 0.5, ratio: 2.37, scan: 0.397, dim: 0.108 },
      { shape: 'diamond', cx: 1169, cy: 185, size: 28, angle: 110, fill: '#4b7576', opacity: 0.362, blend: 'multiply', blur: 0.5, ratio: 1.75, scan: 0.375, dim: 0.189 },
      { shape: 'key', cx: 2369, cy: 1193, size: 25, angle: 104, fill: '#406c5f', opacity: 0.519, blend: 'multiply', blur: 0.5, ratio: 2.48, scan: 0.357, dim: 0.197 },
      { shape: 'crescent', cx: 1505, cy: 929, size: 22, angle: -148, fill: '#cfc7b1', opacity: 0.489, blend: 'screen', blur: 0.5, ratio: 2.02, scan: 0.343, dim: 0.473 },
    ],
  },
  {
    image: 'deheem',
    ...
    clutter: 0.656,
    days: [
      { shape: 'clover', cx: 1793, cy: 1217, size: 29, angle: -168, fill: '#2a1514', opacity: 1, blend: 'screen', blur: 0.5, ratio: 2.45, scan: 0.488, dim: 0.871 },
      { shape: 'triangle', cx: 2441, cy: 1745, size: 27, angle: -25, fill: '#b78f8f', opacity: 0.241, blend: 'screen', blur: 0.5, ratio: 3.56, scan: 0.455, dim: 0.836 },
      { shape: 'blossom', cx: 641, cy: 1793, size: 25, angle: -38, fill: '#cc6982', opacity: 0.237, blend: 'screen', blur: 0.5, ratio: 2.2, scan: 0.429, dim: 0.869 },
      { shape: 'heart', cx: 233, cy: 761, size: 23, angle: -46, fill: '#cb8c70', opacity: 0.123, blend: 'screen', blur: 0.5, ratio: 1.37, scan: 0.388, dim: 0.895 },
      { shape: 'anchor', cx: 2201, cy: 689, size: 20, angle: 70, fill: '#c9bcaa', opacity: 0.371, blend: 'screen', blur: 0.5, ratio: 2.22, scan: 0.381, dim: 0.6 },
      { shape: 'fish', cx: 1049, cy: 689, size: 18, angle: -104, fill: '#cd8283', opacity: 0.493, blend: 'screen', blur: 0.5, ratio: 2.58, scan: 0.363, dim: 0.804 },
      { shape: 'arrow', cx: 2321, cy: 1241, size: 16, angle: 148, fill: '#b8818a', opacity: 0.536, blend: 'screen', blur: 0.5, ratio: 2.31, scan: 0.342, dim: 0.806 },
    ],
  },
  {
    image: 'venice',
    ...
    clutter: 0.538,
    days: [
      { shape: 'triangle', cx: 2249, cy: 449, size: 40, angle: -132, fill: '#cbd4de', opacity: 1, blend: 'multiply', blur: 0.5, ratio: 3.18, scan: 0.498, dim: 0.429 },
      { shape: 'blossom', cx: 1865, cy: 689, size: 37, angle: 97, fill: '#4d7862', opacity: 0.131, blend: 'multiply', blur: 0.5, ratio: 2.08, scan: 0.457, dim: 0.129 },
      { shape: 'cross', cx: 977, cy: 1025, size: 34, angle: 146, fill: '#bba695', opacity: 0.418, blend: 'screen', blur: 0.5, ratio: 2.25, scan: 0.433, dim: 0.723 },
      { shape: 'arrow', cx: 1961, cy: 1601, size: 31, angle: 46, fill: '#bed1b7', opacity: 0.209, blend: 'screen', blur: 0.5, ratio: 1.98, scan: 0.395, dim: 0.496 },
      { shape: 'droplet', cx: 1337, cy: 1313, size: 28, angle: -70, fill: '#c5caad', opacity: 0.245, blend: 'screen', blur: 0.5, ratio: 1.46, scan: 0.379, dim: 0.528 },
      { shape: 'leaf', cx: 185, cy: 1049, size: 25, angle: 104, fill: '#b49e89', opacity: 0.166, blend: 'screen', blur: 0.5, ratio: 1.26, scan: 0.35, dim: 0.753 },
      { shape: 'house', cx: 2273, cy: 881, size: 22, angle: -148, fill: '#c2baa0', opacity: 0.257, blend: 'screen', blur: 0.5, ratio: 1.43, scan: 0.345, dim: 0.609 },
    ],
  },
];
