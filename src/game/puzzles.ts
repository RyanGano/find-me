...
const SEEDS: PuzzleSeed[] = [
  {
    ...
    width: 2600,
    height: 3933,
    target: { shape: 'snowflake', cx: 2120, cy: 1300, size: 40, angle: 41, fill: '#cfe0ea', opacity: 0.202, blend: 'screen', blur: 0.5 },
  },
  {
    id: 'wave',
    ...
    width: 2600,
    height: 1748,
    target: { shape: 'key', cx: 324, cy: 216, size: 40, angle: -48, fill: '#3d5f96', opacity: 0.175, blend: 'multiply', blur: 0.5 },
  },
  {
    id: 'starry',
    ...
    width: 2600,
    height: 2059,
    target: { shape: 'crescent', cx: 880, cy: 1760, size: 40, angle: 112, fill: '#e2ca7c', opacity: 0.245, blend: 'screen', blur: 0.5 },
  },
  {
    id: 'proverbs',
    ...
    width: 2600,
    height: 1841,
    target: { shape: 'clover', cx: 728, cy: 208, size: 40, angle: 24, fill: '#7d5527', opacity: 0.974, blend: 'multiply', blur: 0.5 },
  },
  {
    id: 'jatte',
    ...
    width: 2600,
    height: 1731,
    target: { shape: 'bolt', cx: 2268, cy: 1080, size: 40, angle: 156, fill: '#54613a', opacity: 0.774, blend: 'multiply', blur: 0.5 },
  },
  {
    id: 'delights',
    ...
    width: 2600,
    height: 1480,
    target: { shape: 'heart', cx: 1250, cy: 150, size: 40, angle: -71, fill: '#241a16', opacity: 0.426, blend: 'multiply', blur: 0.5 },
  },
  {
    id: 'hunters',
    ...
    width: 2600,
    height: 1850,
    target: { shape: 'fish', cx: 2016, cy: 336, size: 40, angle: 39, fill: '#4e6274', opacity: 0.257, blend: 'multiply', blur: 0.5 },
  },
  {
    id: 'temeraire',
    ...
    width: 2600,
    height: 1932,
    target: { shape: 'anchor', cx: 784, cy: 1120, size: 40, angle: -124, fill: '#5f4d3b', opacity: 0.364, blend: 'multiply', blur: 0.5 },
  },
];
