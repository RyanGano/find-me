...
const WEEKS: WeekSeed[] = [
  {
    ...
    height: 3933,
    days: [
      { shape: 'snowflake', cx: 521, cy: 2633, size: 40, angle: -168, fill: '#573621', opacity: 1, blend: 'screen', blur: 0.5, ratio: 2.78, scan: 0.789 },
      { shape: 'star', cx: 1841, cy: 1193, size: 37, angle: 47, fill: '#ba9b7b', opacity: 0.497, blend: 'screen', blur: 0.5, ratio: 3.82, scan: 0.649 },
      { shape: 'clover', cx: 1817, cy: 3353, size: 34, angle: 34, fill: '#d07d68', opacity: 0.375, blend: 'screen', blur: 0.5, ratio: 3.03, scan: 0.591 },
      { shape: 'key', cx: 161, cy: 1625, size: 31, angle: -46, fill: '#b9b792', opacity: 0.433, blend: 'screen', blur: 0.5, ratio: 2.13, scan: 0.542 },
      { shape: 'crescent', cx: 1097, cy: 3233, size: 28, angle: 70, fill: '#fceee3', opacity: 1, blend: 'screen', blur: 0.5, ratio: 3.21, scan: 0.52 },
      { shape: 'heart', cx: 1265, cy: 1457, size: 25, angle: -104, fill: '#d18068', opacity: 0.747, blend: 'screen', blur: 0.5, ratio: 3.14, scan: 0.495 },
      { shape: 'anchor', cx: 617, cy: 3545, size: 22, angle: 148, fill: '#c27274', opacity: 0.457, blend: 'screen', blur: 0.5, ratio: 1.54, scan: 0.468 },
    ],
  },
  {
    image: 'wave',
  ...
  },
  {
    ...
    height: 2059,
    days: [
      { shape: 'clover', cx: 521, cy: 1289, size: 40, angle: 12, fill: '#323421', opacity: 1, blend: 'screen', blur: 0.5, ratio: 2.16, scan: 0.624 },
      { shape: 'triangle', cx: 713, cy: 593, size: 37, angle: -25, fill: '#2f3f49', opacity: 0.366, blend: 'multiply', blur: 0.5, ratio: 1.46, scan: 0.512 },
      { shape: 'star', cx: 929, cy: 1121, size: 34, angle: -38, fill: '#504e2c', opacity: 0.348, blend: 'multiply', blur: 0.5, ratio: 1.62, scan: 0.462 },
      { shape: 'arrow', cx: 2441, cy: 929, size: 31, angle: -46, fill: '#56603d', opacity: 0.497, blend: 'multiply', blur: 0.5, ratio: 2.24, scan: 0.43 },
      { shape: 'key', cx: 473, cy: 209, size: 28, angle: 70, fill: '#949fc8', opacity: 0.379, blend: 'screen', blur: 0.5, ratio: 1.09, scan: 0.414 },
      { shape: 'crescent', cx: 1793, cy: 1193, size: 25, angle: -104, fill: '#335049', opacity: 0.625, blend: 'multiply', blur: 0.5, ratio: 1.31, scan: 0.391 },
      { shape: 'heart', cx: 1313, cy: 1841, size: 22, angle: 148, fill: '#8da9bd', opacity: 0.226, blend: 'screen', blur: 0.5, ratio: 0.97, scan: 0.377 },
    ],
  },
  {
    image: 'boating',
