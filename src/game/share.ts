 ...
 * closer of the two, then the ending. A sequence of events and nothing else, so it is
 * spoiler-free by construction. Empty for a run that has no trace -- one recorded before
 * it existed.
 */
